    ...
    <div className="min-h-screen bg-[#020205] text-white overflow-hidden">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#020205]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-300 leading-relaxed mb-6">
            At <strong>Codenclick Technologies</strong>, we don't just build apps; we build businesses. Whether you need a sleek consumer app for iOS or a rugged logistics app for Android, our developers in <strong>New Delhi</strong> craft experiences that feel fluid, fast, and native. We focus on retention, not just downloads.
          </p>
