  ...
  const capabilities = [
    {
      ...
      description: 'Architecting scalable, secure, and high-performance Software-as-a-Service platforms designed for global enterprise needs.',
      details: 'We build robust multi-tenant architectures, real-time analytics engines, and mission-critical dashboards that power businesses.',
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: 'Creating immersive shopping experiences that drive conversion through AI-driven personalization and seamless checkout flows.',
      details: 'From headless commerce to custom inventory management, we engineer digital storefronts that handle millions of transactions.',
      icon: Globe,
      color: 'from-purple-600 to-pink-600',
      keywords: ['Conversion Rate Optimization', 'Headless Commerce', 'Payment Gateways'],
      image: 'https://images.unsplash.com/photo-1661956602116-aa6865609028?w=800&q=80'
    },
    {
      id: 3,
      title: 'Mobile First Solutions',
      description: 'Designing fluid, native-like mobile applications that deliver superior user engagement across iOS and Android ecosystems.',
      details: 'We leverage React Native and Flutter to build cross-platform apps that feel native, perform flawlessly, and scale effortlessly.',
      icon: Smartphone,
      color: 'from-emerald-500 to-teal-500',
      keywords: ['Cross-Platform', 'iOS & Android', 'Performance'],
      image: 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?w=800&q=80'
    },
    {
      id: 4,
      title: 'Brand Identity & UI/UX',
      description: 'Crafting distinct visual identities and intuitive user interfaces that tell a compelling brand story and delight users.',
      details: 'Our design philosophy merges aesthetics with usability, creating digital products that are as beautiful as they are functional.',
      icon: Palette,
      color: 'from-orange-500 to-red-500',
      keywords: ['User Centric', 'Design Systems', 'Brand Strategy'],
      image: 'https://images.unsplash.com/photo-1626785774573-4b799315345d?w=800&q=80'
    },
    {
      id: 5,
      title: 'AI & Machine Learning Integration',
      description: 'Empowering applications with intelligent automation, predictive analytics, and natural language processing capabilities.',
      details: 'We integrate cutting-edge AI models to automate workflows, analyze complex data sets, and provide personalized user experiences.',
      icon: Cpu,
      color: 'from-cyan-500 to-blue-500',
      keywords: ['Predictive Analytics', 'Automation', 'NLP'],
      image: 'https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=800&q=80'
    },
    {
      id: 6,
      title: 'Cybersecurity & Infrastructure',
      description: 'Fortifying digital assets with bank-grade security protocols and resilient cloud infrastructure management.',
      details: 'Security is baked into our code. We implement rigorous compliance standards, automated threat detection, and disaster recovery strategies.',
      icon: Shield,
      color: 'from-slate-700 to-gray-900',
      keywords: ['SOC 2 Compliance', 'Cloud Security', 'data Protection'],
