  ...
  return (
    <section className="relative w-full min-h-screen bg-gray-950 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute -top-40 -left-40 w-80 h-80 bg-blue-600/30 rounded-full blur-3xl animate-float-slow"
        />
        
        {/* Bottom-right purple gradient blob */}
        <div
          className="absolute -bottom-40 -right-40 w-96 h-96 bg-purple-600/20 rounded-full blur-3xl animate-float-medium"
        />

        {/* Center cyan gradient */}
        <div
          className="absolute top-1/2 right-1/4 w-72 h-72 bg-cyan-500/20 rounded-full blur-3xl animate-float-fast"
        />
      </div>
